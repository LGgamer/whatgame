...
bool GameStartPage::init() {
    if (!Layer::init())
        return false;
	//UserDefault::getInstance()->setIntegerForKey("soulForAll", 0);
	...
	weaponbuff2->setPosition(Vec2(900, screenSize.height / 2));
...
void GameStartPage::initWall()
{
	...
	auto testMonster2 = Sprite::create("elements/game.png");
	//testMonster->setAnchorPoint(Vec2(0, 0));
	...
	auto testMonster3 = Sprite::create("elements/gameCenter.png");
	//testMonster->setAnchorPoint(Vec2(0, 0));
	testMonster3->setPosition(Vec2(screenSize.width / 2 + 1000, screenSize.height / 2-1000));
	testMonster3->setScale(0.4);
	testMonster3->setTag(3);
	testMonster3->setName("Wall_4");
	this->addChild(testMonster3);

	auto testMonster4 = Sprite::create("elements/gameCenter2.png");
	//testMonster->setAnchorPoint(Vec2(0, 0));
...
void GameStartPage::write()
{
	...
	//log("soulForthisTurn %d", soulNumber);
