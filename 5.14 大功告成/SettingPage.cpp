...
bool SettingPage::init() {
	...
	backMenuItem->setPosition(Vec2(screenSize.width/2+100, screenSize.height/2- 200));
	...
	auto soundLable = Label::create("sound", "Time New Roman", 50);
	soundLable->setPosition(Vec2(screenSize.width/2, screenSize.height/2 - 100));
	...
	soundToggleMenuItem->setPosition(Vec2(screenSize.width/2+200,screenSize.height/2 - 100));
