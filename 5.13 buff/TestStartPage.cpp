...
bool GameStartPage::init() {
...
#if 1
	auto weaponbuff1 = weapon1::create("attackup2.png");
	weaponbuff1->setPosition(Vec2(200, screenSize.height / 2));
	weaponbuff1->setScale(0.2);
	this->addChild(weaponbuff1);
	weaponbuff1->setTag(7);
	weaponbuff1->setName("attackup");
    ...
    auto maincharacter = character::create("MainCharacter.png");
    maincharacter->setPosition(Vec2(40, screenSize.height / 2));
	...
	//schedule(schedule_selector(GameStartPage::monsterAttack), 0.5, kRepeatForever, 1)
