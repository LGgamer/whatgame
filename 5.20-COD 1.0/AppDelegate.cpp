...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    auto scene = Welcome::createWhatGameScene();
	...
	SimpleAudioEngine::getInstance()->preloadEffect("sound/evil laugh.wav");
	SimpleAudioEngine::getInstance()->preloadEffect("sound/superholy.wav");

	SimpleAudioEngine::getInstance()->setEffectsVolume(0.2);
	auto userDefault = UserDefault::getInstance();
	userDefault->setBoolForKey("isEffect", true);
