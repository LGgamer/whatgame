//this is the congratulation scene which will show up when the game ends
...
bool Congratulation::init()
{
	...
	SimpleAudioEngine::getInstance()->playEffect("sound/superholy.wav");
	auto jump = JumpBy::create(0.5f, Vec2::ZERO, 60, 1);
	auto screenSize = Director::getInstance()->getVisibleSize();
	auto congra = Sprite::create("Congra.png");
	congra->setPosition(Vec2(screenSize.width / 2, screenSize.height - 150));
	...
	auto mainmenu = MenuItemFont::create("Main Menu", CC_CALLBACK_1(Congratulation::mainmenu, this));
...
void Congratulation::showSoul(float dt)
{
	...
	auto soulnumber = UserDefault::getInstance()->getIntegerForKey("soulForthisTurn");
