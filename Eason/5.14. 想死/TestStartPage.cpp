...
void GameStartPage::createPortal(float dt)
{
	...
	auto r = RepeatForever::create(rotation);
...
int GameStartPage::readSoulForThisTurn()
{
	return UserDefault::getInstance()->getIntegerForKey("soulForThisTurn");
}

int GameStartPage::readSoulForAll()
{
	return UserDefault::getInstance()->getIntegerForKey("soulForAll");
}

void GameStartPage::useSoulForAll(int number)
{
	UserDefault::getInstance()->setIntegerForKey("soulForAll", UserDefault::getInstance()->getIntegerForKey("soulForAll") - number);
}
