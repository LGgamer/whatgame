...
bool GameOver::init()
{
	...
	auto restart = MenuItemFont::create("LevelUp", CC_CALLBACK_1(GameOver::restart, this));
	auto mainmenu = MenuItemFont::create("MainMene", CC_CALLBACK_1(GameOver::mainmenu, this));
